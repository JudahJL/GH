...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.context_processors.global_system_status',
            ],
        },
    },
]
...
MODEL_SAVE_PATH = BASE_DIR / "assets" / "waste_model_v1.pth"

if GEMINI_API_KEY is None:
    raise ValueError("GEMINI_API_KEY must be set in your environment")

if not MODEL_SAVE_PATH.exists():
    raise FileNotFoundError(f"MODEL_SAVE_PATH must exist in {MODEL_SAVE_PATH}")
